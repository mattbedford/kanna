...
<header class="bg-surface border-b border-default px-8 py-4 flex items-center justify-between">
    ...
    <div class="flex items-center gap-4">
        ...
        <button id="dark-theme-toggle"
                class="flex items-center p-2 rounded-lg text-muted hover:text-heading hover:bg-surface-alt transition-colors"
                aria-label="Toggle dark mode">
            <!-- Sun icon (shown in dark mode) — Ionicons: sunny-outline -->
            <span id="sun" class="w-5 h-5">
